...
app.config['TEMPLATES_AUTO_RELOAD0'] = True
app.config['UPLOAD_FOLDER'] = './static/profile_pics'

SECRET_KEY = "SPARTA"

MONGODB_CONNECTION = 'mongodb+srv://Fauzan:Fauzan2608.@cluster0.tjckrzw.mongodb.net/?retryWrites=true&w=majority'
client = MongoClient(MONGODB_CONNECTION)
db = client.selfLearn12
